...
const Chatbot = () => (
  <>
    ...
    <a id="chatLauncher" href="#chat" className="fixed bottom-4 right-4 bg-black px-6 py-2.75 text-white font-medium tracking-[0.02em] shadow-[0_2px_6px_rgba(0,0,0,0.1)] transition-colors hover:bg-[#0a0a0a]/90 inline-flex items-center gap-2 rounded-full text-[14px] whitespace-nowrap z-[60]" aria-label="Open chat">
